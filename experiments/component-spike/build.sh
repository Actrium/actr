...
GUEST_TARGET_DIR="$REPO_ROOT/target/experiments-component-spike-guest"
cd "$HERE"

echo "=== [1/3] building guest (wasm32-wasip2) ==="
pushd guest >/dev/null
cargo build --release --target wasm32-wasip2
GUEST_WASM="$GUEST_TARGET_DIR/wasm32-wasip2/release/spike_guest.wasm"
popd >/dev/null
...
STRIPPED="$GUEST_TARGET_DIR/wasm32-wasip2/release/spike_guest.stripped.wasm"
