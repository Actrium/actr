...
// TODO: 实现 DataStreamPeerHandler trait 的所有方法
...
1. **实现业务逻辑**：
   在 `MyDataStreamPeerService` 中实现 `DataStreamPeerHandler` trait 的所有方法
...
4. **启动服务**：
   ...
   async fn main() -> ActorResult<()> {
       let service = MyDataStreamPeerService::new(/* 依赖 */);
