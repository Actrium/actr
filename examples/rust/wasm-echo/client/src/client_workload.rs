//! Client workload — forwards echo requests to the remote WASM server
...
impl MessageDispatcher for ClientDispatcher {
    ...
    async fn dispatch<C: Context>(
        ...
        info!("[ClientWorkload] Forwarding to WASM echo server...");

        // Call remote WASM server via Dest::Actor
