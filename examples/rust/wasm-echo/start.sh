...
echo "  Registering package record for $MFR_NAME:WasmEchoService:0.1.0..."
TYPE_STR="$MFR_NAME:WasmEchoService:0.1.0"
sqlite3 "$ACTRIX_DB" \
...
CLIENT_TYPE_STR="$MFR_NAME:wasm-echo-client-app:0.1.0"
sqlite3 "$ACTRIX_DB" \
