//! # Echo user business logic implementation
//!
...
/// Specific implementation of the Echo service
///
...
// TODO: Implement all methods of the EchoHandler trait
...
1. **Implement business logic**:
   Implement all methods of the `EchoHandler` trait in `MyEchoService`
...
4. **Start service**:
   ...
   async fn main() -> ActorResult<()> {
       let service = MyEchoService::new(/* dependencies */);
