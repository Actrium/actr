...
The `src/generated/` folder is re-generated via `actr gen --input=proto --output=src/generated --no-scaffold` (invoked by the workspace `shell-actr-echo/start.sh`); it is ignored in git.
