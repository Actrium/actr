#!/usr/bin/env bash
#
# readiness.sh — poll actrix service_registry until a service registers.
# Language-agnostic (pure sqlite). Shared by the Kotlin e2e suites.
# Sourced alongside package-runtime-echo/lib/common.sh.
