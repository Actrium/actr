...
- macOS with Xcode + iOS Simulator runtime
- `xcodegen` (`brew install xcodegen`)
- `cargo`, `jq`, `sqlite3`, `python3`, `curl`, `lsof`
- `actrix` binary (auto-resolved: `$ACTRIX_BIN`, `$PATH`, `../actrix`, or clone from GitHub)
...
Runner: `macos-latest`, timeout 120 min.
