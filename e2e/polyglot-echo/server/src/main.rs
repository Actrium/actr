...
//!
//! - `EchoStreamService.StartServerStream`: push N DataChunk chunks to the
...
/// Server-streaming: push `chunk_count` DataChunk chunks to the caller's
/// `client_stream_id`.
...
/// DataChunk chunk back to `client_rx_stream_id`.
