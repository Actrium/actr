...
use actr_protocol::{
    AIdCredential, ActrId, ActrType, Realm, RouteCandidatesRequest, route_candidates_request,
};
...
fn make_actor_id(serial_number: u64) -> ActrId {
    ActrId {
        realm: Realm { realm_id: 1 },
        serial_number,
        r#type: ActrType {
            manufacturer: "acme".to_string(),
            name: "StreamEchoClient".to_string(),
        },
    }
}
