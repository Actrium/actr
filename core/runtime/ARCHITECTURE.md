...
│   ├── data_stream_registry.rs     # data stream fast path registry
...
**DataStreamRegistry**：
- Responsibility: Manage data stream callback registry (stream_id → callback)
...
### 7.2 Data Stream Fast Path Flow
