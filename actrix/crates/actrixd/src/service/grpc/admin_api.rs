use actrix_sdk::control::{AdminApiService, AuthService, SupervisedServiceServer};
use anyhow::Result;
use platform::{ServiceCollector, config::SupervisorConfig, storage::nonce::SqliteNonceStorage};
...
///
/// 当前实现承载的是 Supervisor 回连节点时使用的 SupervisedService。
#[derive(Debug)]
