...
fn build_credential_for_payload(shared_secret: &[u8], payload: &str) -> testing::NonceCredential {
...
fn build_node_info_credential(shared_secret: &[u8], node_id: &str) -> testing::NonceCredential {
