...
static REGISTRY: &[ConfigFieldDef] = &[
    ...
    // ── KS ────────────────────────────────────────────────────────
    ConfigFieldDef {
        key: "services.ks.storage.key_ttl_seconds",
        toml_path: "services.ks.storage.key_ttl_seconds",
        value_type: ConfigValueType::U64,
        default_value: "3600",
        dynamic: true,
        reloadable: true,
    ...
    ConfigFieldDef {
        key: "services.ks.tolerance_seconds",
        toml_path: "services.ks.tolerance_seconds",
        value_type: ConfigValueType::U64,
        default_value: "300",
        dynamic: true,
        reloadable: true,
